...
- `supabase/migrations/` — `001`–`022` (initial schema, guild_path rename, source attribution, price_includes, plus_ones, cancelled status, user_credits, leads, llm_notes, user_promos, guild_path_exclusive, guest admins, waitlist fields, Demon's Draft submissions, corporate events, externally managed registrations, finance ledger, all-day/multi-day events, REPLAY pass perk, community hosts)
