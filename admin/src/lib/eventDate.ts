// Mirror of src/lib/event-date.ts. The admin SPA is a separate package and
// can't import from the public site, so the rules are duplicated — keep both
// files in sync.
//
...
// calendar day must not shift for an admin travelling elsewhere.
